...
struct YASM_LIB_EXPORT GenericOptionValue {
...
template<>
struct YASM_LIB_EXPORT OptionValue<cl::boolOrDefault> : OptionValueCopy<cl::boolOrDefault> {
...
template<>
struct YASM_LIB_EXPORT OptionValue<std::string> : OptionValueCopy<std::string> {
...
//
class YASM_LIB_EXPORT generic_parser_base {
protected:
...
//
class YASM_LIB_EXPORT basic_parser_impl {  // non-template implementation of basic_parser<t>
public:
