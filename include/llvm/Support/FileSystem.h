...
class file_status
{
  ...
  #endif
  friend YASM_LIB_EXPORT bool equivalent(file_status A, file_status B);
  friend YASM_LIB_EXPORT error_code status(const Twine &path, file_status &result);
  file_type Type;
  perms Perms;
public:
...
/// called.
class YASM_LIB_EXPORT directory_entry {
  std::string Path;
...
class YASM_LIB_EXPORT recursive_directory_iterator {
