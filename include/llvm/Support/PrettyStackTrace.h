...
namespace llvm {
  ...
  /// Defaults to false.
  extern YASM_LIB_EXPORT bool DisablePrettyStackTrace;
  ...
  class YASM_LIB_EXPORT PrettyStackTraceEntry {
  ...
  /// occurs.
  class YASM_LIB_EXPORT PrettyStackTraceString : public PrettyStackTraceEntry {
    const char *Str;
  public:
  ...
  class YASM_LIB_EXPORT PrettyStackTraceProgram : public PrettyStackTraceEntry {
    int ArgC;
