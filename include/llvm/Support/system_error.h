...
class YASM_LIB_EXPORT error_category
{
public:
  virtual ~error_category();
...
class YASM_LIB_EXPORT _do_message : public error_category
{
public:
  _do_message() {}
  virtual std::string message(int ev) const;
private:
  _do_message(const _do_message&);// = delete;
  _do_message& operator=(const _do_message&);// = delete;
};
...
class YASM_LIB_EXPORT error_condition
{
  int _val_;
...
class YASM_LIB_EXPORT error_code {
  int _val_;
  const error_category* _cat_;
public:
