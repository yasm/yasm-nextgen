...
#include "yasmx/Basic/DiagnosticIDs.h"
...
/// SourceManager.
class YASM_LIB_EXPORT DiagnosticsEngine : public RefCountedBase<DiagnosticsEngine> {
public:
...
inline DiagnosticBuilder DiagnosticsEngine::Report(SourceLocation Loc,
  ...
  assert(SourceMgr != 0 && "Generated unexpected diagnostic!");
  CurDiagLoc = FullSourceLoc(Loc, *SourceMgr);
  CurDiagID = DiagID;
...
class YASM_LIB_EXPORT DiagnosticConsumer {
protected:
  unsigned NumWarnings;       ///< Number of warnings reported
  unsigned NumErrors;         ///< Number of errors reported
