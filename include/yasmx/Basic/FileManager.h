...
#ifndef YASM_FILEMANAGER_H
#define YASM_FILEMANAGER_H
...
#include "yasmx/Basic/FileSystemOptions.h"
...
/// as a single file.
///
class YASM_LIB_EXPORT FileManager : public RefCountedBase<FileManager> {
