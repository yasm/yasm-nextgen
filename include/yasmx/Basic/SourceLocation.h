...
namespace llvm {
  ...
  template<>
  class PointerLikeTypeTraits<yasm::SourceLocation> {
  public:
    static inline void *getAsVoidPointer(yasm::SourceLocation L) {
      return L.getPtrEncoding();
    }
    static inline yasm::SourceLocation getFromVoidPointer(void *P) {
      return yasm::SourceLocation::getFromRawEncoding((unsigned)(uintptr_t)P);
    }
