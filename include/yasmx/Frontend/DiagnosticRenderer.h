...
#ifndef YASM_FRONTEND_DIAGNOSTIC_RENDERER_H_
#define YASM_FRONTEND_DIAGNOSTIC_RENDERER_H_
...
/// class.
class YASM_LIB_EXPORT DiagnosticRenderer {
protected:
  ...
  DiagnosticRenderer(const DiagnosticOptions &DiagOpts);
...
class YASM_LIB_EXPORT DiagnosticNoteRenderer : public DiagnosticRenderer {
public:
  DiagnosticNoteRenderer(const DiagnosticOptions &DiagOpts)
